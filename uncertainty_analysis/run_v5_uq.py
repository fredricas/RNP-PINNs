...
_LOCAL_MPLCONFIG = Path(__file__).resolve().parent / ".mplconfig"
...
WORKING_COPY = HERE / "working_copy"
BASELINE_OUTPUT = WORKING_COPY / "v5_baseline"
ELECTRIC_CHECKPOINT = WORKING_COPY / "common_prefix" / "electric" / "checkpoint_electric.ckpt"
WATER_CHECKPOINT = WORKING_COPY / "common_prefix" / "water" / "checkpoint_water.ckpt"
...
def main():
    ...
    args.baseline_config_path = baseline_path.parent / "run_config.json"
