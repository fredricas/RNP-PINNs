...
Start two refits in parallel as a hidden resumable job:

```powershell
.\start_formal_uq.ps1 -PythonExe .\venv\Scripts\python.exe
```

Check progress with `./show_status.ps1`. Results are written beneath `outputs`.
